...
class MT4Type(object):
    """baseclass for MT4 types."""
...
class AccountID(MT4Type):
    ...
    accountID : string (required)
        the accountID of a MT4 account

    Example
    -------

        >>> print AccountID("12345678").value
    ...
    def __init__(self, accountID):
        # MT4 account ID is typically a number (no special format required)
        if not str(accountID).isdigit():
            msg = "AccountID {} not a valid MT4 account".format(accountID)
            raise ValueError(msg)

        self._v = {"accountID": str(accountID)}


class OrderID(MT4Type):
